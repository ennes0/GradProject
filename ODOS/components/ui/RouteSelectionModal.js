      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.headerContent}>
            <Text style={styles.headerTitle}>{tx('Rota Seçin', 'Select Route')}</Text>
            <Text style={styles.headerSubtitle}>
              {startLocation || tx('Başlangıç', 'Start')} → {endLocation || tx('Varış', 'Arrival')}
            </Text>
          </View>
            ...
            >
              {route.recommended && (
                <View style={styles.recommendedBadge}>
                  ...
                  <Text style={styles.recommendedText}>{tx('Önerilen', 'Recommended')}</Text>
                </View>
              )}
              ...
              <View style={styles.elevationSection}>
                <View style={styles.elevationHeader}>
                  <Text style={styles.elevationLabel}>{tx('Yükselti Profili', 'Elevation Profile')}</Text>
                  {route.avgSlope ? (
